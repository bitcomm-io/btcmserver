;console.log('源码只发布在: https://www.17sucai.com ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('oo')<0){}};console.log('下载源码请访问：https://www.17sucai.com');(function ($, moment)
{
