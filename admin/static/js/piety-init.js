;console.log('源码下载唯一地址: https://www.17sucai.com ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('boot')<0){}};console.log('下载源码请访问：https://www.17sucai.com');console.log('下载源码请访问：https://www.17sucai.com');
(function($) {
    "use strict"
